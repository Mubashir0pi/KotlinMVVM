...
class LocationTracker(private val mContext: Context) : Service(), LocationListener {
    ...
    /**
     * Function to show settings_fragment alert dialog
    ...
    fun showSettingsAlert() {
        ...
        alertDialog.setTitle("GPS is settings_fragment")

        // Setting Dialog Message
        alertDialog.setMessage("GPS is not enabled. Do you want to go to settings_fragment menu?")
